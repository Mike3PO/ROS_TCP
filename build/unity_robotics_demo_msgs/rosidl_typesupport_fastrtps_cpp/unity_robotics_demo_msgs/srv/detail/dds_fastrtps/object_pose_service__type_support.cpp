...
#include "unity_robotics_demo_msgs/srv/detail/object_pose_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unity_robotics_demo_msgs::srv::ObjectPoseService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unity_robotics_demo_msgs::srv::ObjectPoseService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unity_robotics_demo_msgs::srv::ObjectPoseService_Request *>(
    untyped_ros_message);
...
{
  return &unity_robotics_demo_msgs::srv::typesupport_fastrtps_cpp::_ObjectPoseService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = unity_robotics_demo_msgs::srv::ObjectPoseService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unity_robotics_demo_msgs::srv::ObjectPoseService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<unity_robotics_demo_msgs::srv::ObjectPoseService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &unity_robotics_demo_msgs::srv::typesupport_fastrtps_cpp::_ObjectPoseService_Response__handle;
}
...
static rosidl_service_type_support_t _ObjectPoseService__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &unity_robotics_demo_msgs::srv::typesupport_fastrtps_cpp::_ObjectPoseService__handle;
}
